    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/dig_gov/";
            },},{
        id: 'social-cv',
        title: 'CV',
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/Karpa_CV_Oct25.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%64%61%76%69%64%66%6B%61%72%70%61@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=G24AjDUAAAAJ", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://bsky.app/profile/dkarpa.bsky.social", "_blank");
        },
      },{
      id: 'light-theme',
